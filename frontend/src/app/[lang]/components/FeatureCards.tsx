...
function FeatureCard({ ...card }: CardInterface) {
  return (
    <li className="rounded-md bg-white p-3 pb-5 drop-shadow-2xl">
      ...
      <div className="mt-3 flex items-center justify-between">
        <div className="flex items-center gap-1">
          <Image
            src={getStrapiMedia(card.profilePicture.data.attributes.url) || ''}
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-1">
            ...
            <p className="font-body font-bold text-black">{card.amount}</p>
          </div>
        </div>
      </div>
    </li>
